...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2019 at 11:47 PM
...
(21, 'Bhartiya Vynjano ka khajana', '25', 'Vyanjan made by Henry kapoor,he makes very sweet and delicious dishes', 'Henry Kapoor', '2009', 'vya12', 120, 350, 'upload_image/bhartiya.jpg', 'upload_ebook/Vyanjan.docx'),
...
(5, 'Department of Law (Morning)'),
(6, 'Department of Law (evening)'),
(7, 'Economics'),
(8, 'Low Books'),
(12, 'Management');
...
(4, 'dsfdsf', ' sdfsdf', 4566, 'gfgfgf', 'fdggd', 0, '123456789');
...
(11, 'bawan', 'bawan1887', '12345678', 'Male', 'bawan.xalid33@bawan.com', '009640000000', 'Sulaimanyah');
...
--
ALTER TABLE `user`
  MODIFY `u_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
COMMIT;
